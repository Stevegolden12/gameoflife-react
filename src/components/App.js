...
App.propTypes = {
  ...
  rows: PropTypes.func,
  cols: PropTypes.func,
  generationHistory: PropTypes.array,
  handlePlayButton: PropTypes.func,
  handlePauseButton: PropTypes.func,
  handleNextGeneration: PropTypes.func,
  handleClearBoard: PropTypes.func,
  handleRandomBoard: PropTypes.func,
  handlePrevGeneration: PropTypes.func,
  handleSizeSpeedUpdate: PropTypes.func
}
